<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{ route('getFacilities') }}" class="nav-item nav-link"> <i class="fas fa-utensils me-2"></i>Facilities</a>

            <a href="{{ route('eventsPage') }}" class="nav-item nav-link"><i class="fas fas fa-calendar-alt me-2"></i>Events</a> 
