...
<head>
    ...
    <title>KPVH - Travel & Tour Booking Agency HTML Template - Home Hiking Style2</title>
    <meta name="author" content="KPVH">
    <meta name="description" content="KPVH - Travel & Tour Booking Agency HTML Template ">
    <meta name="keywords" content="KPVH - Travel & Tour Booking Agency HTML Template ">
            ...
            <div class="widget  ">
                <div class="th-widget-about">
                    <div class="about-logo">
                        <a href="home-travel.html"><img src="assets/img/logo2.svg" alt="KPVH"></a>
                    </div>
            ...
            <div class="widget  ">
                ...
                <div class="th-widget-contact">
                    ...
                    <div class="info-box_text">
                        ...
                        <div class="details">
                            <p><a href="mailto:mailinfo00@KPVH.com" class="info-box_link">mailinfo00@KPVH.com</a></p>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a href="index.html">
                                    <img src="assets/img/logo3.svg" alt="KPVH">
                                </a>
                            </div>
                        </div>
                        <div class="col-auto">
                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                ...
                                                                <h3 class="mega-menu-title"><a href="home-hiking-2.html"><span>10.</span>Home Hiking
                                                                        Style 2</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img">
                                                                    <img src="assets/img/pages/home-cruise-tour.jpg" alt="Home ten">
                                                                    <div class="btn-wrap">
                                                                        <a target="_blank" href="home-cruise-tour.html" class="th-btn ">View Demo</a>
                                                                    </div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a href="home-cruise-tour.html"><span>11.</span>Home Cruise
                                                                        Tour</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img">
                                                                    <img src="assets/img/pages/home-travel-agency.jpg" alt="Home ten">
                                                                    <div class="btn-wrap">
                                                                        <a target="_blank" href="home-travel-agency.html" class="th-btn ">View Demo</a>
                                                                    </div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a href="home-travel-agency.html"><span>12.</span>Home
                                                                        Travel Agency</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img">
                                                                    <img src="assets/img/pages/home-museum-tour.jpg" alt="Home ten">
                                                                    <div class="btn-wrap">
                                                                        <a target="_blank" href="home-museum-tour.html" class="th-btn ">View Demo</a>
                                                                    </div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a href="home-museum-tour.html"><span>13.</span>Home Museum
                                                                        Tour</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img">
                                                                    <img src="assets/img/pages/home-worldwide-tour.jpg" alt="Home ten">
                                                                    <div class="btn-wrap">
                                                                        <a target="_blank" href="home-worldwide-tour.html" class="th-btn ">View Demo</a>
                                                                    </div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a href="home-worldwide-tour.html"><span>14.</span>Home
                                                                        Worldwide Tour</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img">
                                                                    <img src="assets/img/pages/home-city-tour.jpg" alt="Home ten">
                                                                    <div class="btn-wrap">
                                                                        <a target="_blank" href="home-city-tour.html" class="th-btn ">View Demo</a>
                                                                    </div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a href="home-city-tour.html"><span>15.</span>Home
                                                                        City Tour</a>
                                                                </h3>
                                                            </div>
                                                        </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_10_1.jpg">
                        </div>

                        <div class="container">
                            <div class="hero-style10">
                                <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.4s">
                                    <span class="hero-title2">See the World,</span>
                                    Live the Adventure
                                </h1>
                                <div class="btn-group" data-ani="slideinup" data-ani-delay="0.6s">
                                    <a href="destination.html" class="th-btn style2 th-icon">Explore Tours</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_10_2.jpg">
                        </div>
                        <div class="container">
                            <div class="hero-style10">
                                <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.4s">
                                    <span class="hero-title2">Journey Through the
                                    </span>Marvels of Time
                                </h1>
                                <div class="btn-group" data-ani="slideinup" data-ani-delay="0.6s">
                                    <a href="destination.html" class="th-btn style2 th-icon">Explore Tours</a>
                                </div>
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_10_3.jpg">
                        </div>

                        <div class="container">
                            <div class="hero-style10">
                                <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.4s">
                                    <span class="hero-title2">Enjoy The Most</span> Enjoyable Journey
                                </h1>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="hero-inner">
                                        <div class="hero10-card">
                                            <div class="hero-img">
                                                <img src="assets/img/hero/hero_10_1.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="hero-inner">
                                        <div class="hero10-card">
                                            <div class="hero-img">
                                                <img src="assets/img/hero/hero_10_2.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="hero-inner">
                                        <div class="hero10-card">
                                            <div class="hero-img">
                                                <img src="assets/img/hero/hero_10_3.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row justify-content-xl-between justify-content-center align-items-end">
                ...
                <div class="col-lg-auto d-none d-lg-block">
                    <div class="sec-btn">
                        <div class="icon-box">
                            <button data-slider-prev="#categorySlider7" class="slider-arrow default style6"><img src="assets/img/icon/right-arrow2.svg" alt=""></button>
                            <button data-slider-next="#categorySlider7" class="slider-arrow default style6"><img src="assets/img/icon/left-arrow2.svg" alt=""></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="slider-area">
                <div class="swiper th-slider has-shadow" id="categorySlider7" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"3"},"992":{"slidesPerView":"4"},"1200":{"slidesPerView":"5"},"1300":{"slidesPerView":"6"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                ...
                <div class="col-xl-6">
                    <div class=" ps-xl-5">
                        <div class="title-area mb-20">
                            ...
                            <h2 class="sec-title mb-20 heading">We Take You Places, You
                                Make the Memories</h2>

                            <p class="sec-text mb-30">There are many variations of passages of available but the majority
                                have suffered alteration in some form, by injected hum randomised words which don't look
                                even slightly. </p>
                        </div>
                ...
                <div class="swiper th-slider has-shadow" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1300":{"slidesPerView":"4"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="destination-item4 th-ani">
                                <div class="destination-item4_img global-img" data-mask-src="assets/img/destination/shape.png">
                                    <img src="assets/img/destination/destination_9_1.jpg" alt="image">
                                </div>
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="destination-details.html"><img src="assets/img/icon/location-dot4.svg" alt="">Thailand</a></h3>
                                </div>
                                <a href="contact.html" class="icon-btn"><img src="assets/img/icon/left-arrow4.svg" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item4 th-ani">
                                <div class="destination-item4_img global-img" data-mask-src="assets/img/destination/shape.png">
                                    <img src="assets/img/destination/destination_9_2.jpg" alt="image">
                                </div>
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="destination-details.html"><img src="assets/img/icon/location-dot4.svg" alt="">Belgium</a></h3>
                                </div>
                                <a href="contact.html" class="icon-btn"><img src="assets/img/icon/left-arrow4.svg" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item4 th-ani">
                                <div class="destination-item4_img global-img" data-mask-src="assets/img/destination/shape.png">
                                    <img src="assets/img/destination/destination_9_3.jpg" alt="image">
                                </div>
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="destination-details.html"><img src="assets/img/icon/location-dot4.svg" alt="">Island</a></h3>
                                </div>
                                <a href="contact.html" class="icon-btn"><img src="assets/img/icon/left-arrow4.svg" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item4 th-ani">
                                <div class="destination-item4_img global-img" data-mask-src="assets/img/destination/shape.png">
                                    <img src="assets/img/destination/destination_9_4.jpg" alt="image">
                                </div>
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="destination-details.html"><img src="assets/img/icon/location-dot4.svg" alt="">Maldives</a></h3>
                                </div>
                                <a href="contact.html" class="icon-btn"><img src="assets/img/icon/left-arrow4.svg" alt=""></a>
                            </div>
                        </div>
...
==============================-->
    <div class="position-relative overflow-hidden space">
        <div class="cta-sec6 bg-title position-relative overflow-hidden">
            ...
            <div class="shape-mockup" data-bottom="0%" data-right="-2%"><img src="assets/img/normal/cta-img-6.jpg" alt="">
            </div>
        </div>
    </div>
...
team Area  
==============================-->
    <section class="team-area9 overflow-hidden space-bottom" id="team-sec">
        <div class="container">
            ...
            <div class="slider-area">
                <div class="swiper th-slider teamSlider8 has-shadow" id="teamSlider8" data-slider-options='{"breakpoints":{"0":{"slidesPerView":3},"767":{"slidesPerView":"3"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"4"},"1400":{"slidesPerView":"4"}}}'>
                    <div class="swiper-wrapper">
                        <!-- Single Item -->
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-grid2">
                                ...
                                <div class="team-content">
                                    <h3 class="box-title"><a href="tour-guider-details.html">Mishel Marsh</a></h3>
                                    <div class="th-social">
                                        <a href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                        <a href="https://www.linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                                        <a href="https://www.twitter.com/"><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="swiper th-slider has-shadow" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"4"}}}'>
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_10_1.jpg" alt="image">
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_10_2.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_10_3.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_10_4.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                ...
                <div class="col-lg-6">
                    <div class="ps-xl-5">
                        <div class="title-area">
                            ...
                            <h2 class="sec-title">Wander Far, Explore More</h2>
                            <p>Enjoy different experiences in every place you visit and discover new and affordable
                                adventures of course.</p>
                        </div>
                        <div class="choose-about style2 hover-item item-active">
                            <div class="choose-about_icon">
                                <img src="assets/img/icon/choose_2_1.svg" alt="image">
                            </div>
                            <div class="media-body">
                                <h3 class="box-title">Flight Ticket</h3>
                                <p class="choose-about_text">Vitae donec pellentesque a aliquam et ultricies auctor. </p>
                            </div>
                        </div>
                        <div class="choose-about style2 hover-item  ">
                            <div class="choose-about_icon">
                                <img src="assets/img/icon/choose_2_2.svg" alt="image">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="choose-about style2 hover-item  ">
                            <div class="choose-about_icon">
                                <img src="assets/img/icon/choose_2_3.svg" alt="image">
                            </div>
                            <div class="media-body">
                                <h3 class="box-title">Packaged Tour</h3>
                                <p class="choose-about_text">Vitae donec pellentesque a aliquam et ultricies auctor. </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testi-card3">
                                <div class="box-img">
                                    <img src="assets/img/testimonial/testi_bg_1.jpg" alt="">
                                </div>
                                <div class="box-content">
                                    <div class="box-profile">
                                        <div class="box-avater">
                                            <img src="assets/img/testimonial/testi_6_1.png" alt="">
                                        </div>
                                        <p class="box-text">““Major travel agencies include global players like TUI, Thomas Cook, Flight Centre, and American Express Travel, alongside many boutique and local agencies that offer more tailored services.””</p>
                                        <div class="media-body">
                                    ...
                                    <div class="box-quote">
                                        <img src="assets/img/icon/testi-quote2.svg" alt="img">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testi-card3">
                                <div class="box-img">
                                    <img src="assets/img/testimonial/testi_bg_2.jpg" alt="">
                                </div>
                                <div class="box-content">
                                    <div class="box-profile">
                                        <div class="box-avater">
                                            <img src="assets/img/testimonial/testi_6_2.png" alt="">
                                        </div>
                                        <p class="box-text">“The home boasts sleek, contemporary architecture with clean lines and expansive windows, allowing natural light to flood the interiors It incorporates passive design principles”</p>
                                        <div class="media-body">
                        ...
                        <div class="swiper-slide">
                            <div class="testi-card3">
                                <div class="box-img">
                                    <img src="assets/img/testimonial/testi_bg_3.jpg" alt="">
                                </div>
                                <div class="box-content">
                                    <div class="box-profile">
                                        <div class="box-avater">
                                            <img src="assets/img/testimonial/testi_6_3.png" alt="">
                                        </div>
                                        <p class="box-text">“Solar panels adorn the roof, harnessing renewable energy to power the home and even feed excess electricity back into the grid. High-performance insulation and triple-glazed”</p>
                                        <div class="media-body">
                            ...
                            <div class="testi-card3">
                                ...
                                <div class="box-content">
                                    <div class="box-profile">
                                        ...
                                        <p class="box-text">A sophisticated rainwater harvesting system collects and filters rainwater for irrigation and non-potable uses, reducing reliance on municipal water sources. Greywater systems</p>
                                        <div class="media-body">
                                            <h3 class="box-title">Alex Carlose</h3>
                                            <span class="box-desig">Traveller</span>
                                        </div>
                            ...
                            <div class="testi-card3">
                                ...
                                <div class="box-content">
                                    <div class="box-profile">
                                        ...
                                        <p class="box-text">Throughout the interior, eco-friendly materials like reclaimed wood, bamboo flooring, and recycled glass countertops create a luxurious yet sustainable ambiance.</p>
                                        <div class="media-body">
                                            <h3 class="box-title">Maria Doe</h3>
                                            <span class="box-desig">Traveller</span>
                                        </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-7">
                        <div class="title-area mb-md-0">
                            ...
                            <h2 class="sec-title">News & Articles From KPVH</h2>
                        </div>
                    </div>
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-xl-6">
                        <div class="newsletter-wrapper ps-xl-4">
                            <h4 class="h2 newsletter-title text-white">Subscribe To Our Mailing
                                List And Stay Up To Date</h4>
                            <p class="newsletter-text text-white">Travel agencies handle the logistics of travel, saving customers from
                                the
                                time-consuming process of planning and booking.</p>
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="newsletter-image">
                            <img src="assets/img/normal/newsletter-img.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer-wrapper bg-title footer-layout2">
                ...
                <div class="row justify-content-between">
                    <div class="col-md-6 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                <div class="about-logo">
                                    <a href="home-travel.html"><img src="assets/img/logo-white.svg" alt="KPVH"></a>
                                </div>
                                <p class="about-text">Rapidiously myocardinate cross-platform intellectual capital model. Appropriately create interactive infrastructures</p>
                                <div class="th-social">
                                    <a href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
        ...
        <div class="copyright-wrap">
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-md-6">
                        <p class="copyright-text">Copyright 2025 <a href="home-travel.html">KPVH</a>. All Rights Reserved.</p>
                    </div>
